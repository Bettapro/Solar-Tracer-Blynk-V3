...
VariableDefiner::VariableDefiner()
{
    ...
    this->initializeVariable(Variable::MAXIMUM_PV_VOLTAGE_TODAY, "Today PV min. volt.", VariableDatatype::DT_FLOAT, VariableUOM::UOM_VOLT, VariableSource::SR_STATS, VariableMode::MD_READ, vPIN_MIN_PV_VOLTAGE_TODAY_DF, MQTT_TOPIC_MIN_PV_VOLTAGE_TODAY_DF);
    ...
    this->initializeVariable(Variable::BATTERY_STATUS_TEXT, "Batt. status", VariableDatatype::DT_STRING, VariableUOM::UOM_UNDEFINED, VariableSource::SR_REALTIME, VariableMode::MD_READWRITE, vPIN_BATTERY_STATUS_TEXT_DF, MQTT_TOPIC_BATTERY_STATUS_TEXT_DF);

...
const mqttSolarVariableMap realTimeVirtualMqttSolarVariables [] = {
  ...
  {MQTT_TOPIC_PV_CURRENT, SolarTracerVariables::PV_CURRENT},
#endif
#ifdef MQTT_TOPIC_PV_VOLTAGE
  {MQTT_TOPIC_PV_VOLTAGE, SolarTracerVariables::PV_VOLTAGE},
#endif
#ifdef MQTT_TOPIC_LOAD_CURRENT
  {MQTT_TOPIC_LOAD_CURRENT, SolarTracerVariables::LOAD_CURRENT},
#endif
#ifdef MQTT_TOPIC_LOAD_POWER
  {MQTT_TOPIC_LOAD_POWER, SolarTracerVariables::LOAD_POWER},
#endif
#ifdef MQTT_TOPIC_BATT_TEMP
  {MQTT_TOPIC_BATT_TEMP, SolarTracerVariables::BATTERY_TEMP},
#endif
#ifdef MQTT_TOPIC_BATT_VOLTAGE
  {MQTT_TOPIC_BATT_VOLTAGE, SolarTracerVariables::BATTERY_VOLTAGE},
#endif
#ifdef MQTT_TOPIC_BATT_REMAIN
  {MQTT_TOPIC_BATT_REMAIN, SolarTracerVariables::BATTERY_SOC},
#endif
#ifdef MQTT_TOPIC_CONTROLLER_TEMP
  {MQTT_TOPIC_CONTROLLER_TEMP, SolarTracerVariables::CONTROLLER_TEMP},
#endif
#ifdef MQTT_TOPIC_BATTERY_CHARGE_CURRENT
  {MQTT_TOPIC_BATTERY_CHARGE_CURRENT, SolarTracerVariables::BATTERY_CHARGE_CURRENT},
#endif
#ifdef MQTT_TOPIC_BATTERY_CHARGE_POWER
  {MQTT_TOPIC_BATTERY_CHARGE_POWER, SolarTracerVariables::BATTERY_CHARGE_POWER},
#endif
#ifdef MQTT_TOPIC_BATTERY_OVERALL_CURRENT
  {MQTT_TOPIC_BATTERY_OVERALL_CURRENT, SolarTracerVariables::BATTERY_OVERALL_CURRENT},
#endif
#ifdef MQTT_TOPIC_LOAD_ENABLED
  {MQTT_TOPIC_LOAD_ENABLED, SolarTracerVariables::LOAD_MANUAL_ONOFF},
#endif
#ifdef MQTT_TOPIC_CHARGE_DEVICE_ENABLED
  {MQTT_TOPIC_CHARGE_DEVICE_ENABLED, SolarTracerVariables::CHARGING_DEVICE_ONOFF},
#endif
#ifdef MQTT_TOPIC_BATTERY_STATUS_TEXT
  {MQTT_TOPIC_BATTERY_STATUS_TEXT, SolarTracerVariables::BATTERY_STATUS_TEXT},
#endif
#ifdef MQTT_TOPIC_CHARGING_EQUIPMENT_STATUS_TEXT
  {MQTT_TOPIC_CHARGING_EQUIPMENT_STATUS_TEXT, SolarTracerVariables::CHARGING_EQUIPMENT_STATUS_TEXT},
#endif
#ifdef MQTT_TOPIC_DISCHARGING_EQUIPMENT_STATUS_TEXT
  {MQTT_TOPIC_DISCHARGING_EQUIPMENT_STATUS_TEXT, SolarTracerVariables::DISCHARGING_EQUIPMENT_STATUS_TEXT},
#endif
#ifdef MQTT_TOPIC_CONTROLLER_HEATSINK_TEMP
  {MQTT_TOPIC_CONTROLLER_HEATSINK_TEMP, SolarTracerVariables::HEATSINK_TEMP},
#endif
};
const mqttSolarVariableMap statVirtualMqttSolarVariables [] = {
  #ifdef MQTT_TOPIC_STAT_ENERGY_GENERATED_TODAY
  {MQTT_TOPIC_STAT_ENERGY_GENERATED_TODAY, SolarTracerVariables::GENERATED_ENERGY_TODAY},
#endif
#ifdef MQTT_TOPIC_STAT_ENERGY_GENERATED_THIS_MONTH
  {MQTT_TOPIC_STAT_ENERGY_GENERATED_THIS_MONTH, SolarTracerVariables::GENERATED_ENERGY_MONTH},
#endif
#ifdef MQTT_TOPIC_STAT_ENERGY_GENERATED_THIS_YEAR
  {MQTT_TOPIC_STAT_ENERGY_GENERATED_THIS_YEAR, SolarTracerVariables::GENERATED_ENERGY_YEAR},
#endif
#ifdef MQTT_TOPIC_STAT_ENERGY_GENERATED_TOTAL
  {MQTT_TOPIC_STAT_ENERGY_GENERATED_TOTAL, SolarTracerVariables::GENERATED_ENERGY_TOTAL},
#endif
};

...
//#define USE_MQTT
  ...
  #define MQTT_TOPIC_BATT_TEMP                                MQTT_TOPIC_ROOT "battery_power"
  ...
  #define MQTT_TOPIC_BATTERY_CHARGE_CURRENT                   MQTT_TOPIC_ROOT "battery_charge_current"
  #define MQTT_TOPIC_BATTERY_CHARGE_POWER                     MQTT_TOPIC_ROOT "battery_charge_power"
  ...
  #define MQTT_TOPIC_BATTERY_DISCHARGING_LIMIT_VOLTAGE        MQTT_TOPIC_ROOT "battery_settings_dischargin_limit_voltage"
  #define MQTT_TOPIC_BATTERY_LOW_VOLTAGE_DISCONNECT           MQTT_TOPIC_ROOT "battery_settings_lowVoltage_disconnect"
  #define MQTT_TOPIC_BATTERY_LOW_VOLTAGE_RECONNECT            MQTT_TOPIC_ROOT "battery_settings_loVoltage_reconnect"
